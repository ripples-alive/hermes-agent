...
def _normalize_codex_response(
    ...
    *,
    ...
    if tool_calls:
        ...
        # the Codex continuation path handles it correctly. If a completed
        # response has both a stale in_progress reasoning item and a final
        # message, the stale reasoning status above is ignored and this branch
        # is bypassed because final_text is present.
        finish_reason = "incomplete"
    else:
        finish_reason = "stop"
